...
# from eth_abi.grammar import ABIType, BasicType, TupleType
...
# """.format(
#         name=NAME_REGEX,
#         arg=FUNCTION_ARGUMENT_REGEX,
#     ),
#     re.VERBOSE,
# )


# def extract_function_signatures(code) -> List[str]:
#     """
...
# def extract_function_name(raw_signature) -> Tuple[str, str]:
